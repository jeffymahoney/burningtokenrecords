 ...
 */
function btr_profile_form_install_configure_form_alter(&$form, $form_state) {
  ...
  $form['site_information']['site_name']['#default_value'] = 'Burning Token Records';
  $form['admin_account']['account']['name']['#default_value'] = 'burningtokenrecords';
 ...
 */
function btr_profile_install_tasks_alter(&$tasks, $install_state) {
  // Uses Panopoly's method of dependency handling.
  $tasks['install_load_profile']['function'] = 'btr_profile_install_load_profile';
}
 ...
 */
function btr_profile_install_load_profile(&$install_state) {
 ...
 * password is set).
 */
function btr_profile_install_tasks($install_state) {
  // Adds a CSS file for the installation process.
  drupal_add_css(drupal_get_path('profile', 'btr_profile') . '/btr_profile.css');
  ...
  $tasks = array(
    'btr_profile_install_set_variables' => array(
  ...
  // Sets the theme to burningtokenrecords.
  $tasks['btr_profile_install_set_theme'] = array(
 ...
 */
function btr_profile_install_set_variables() {
...
/**
 * Enables the burningtokenrecords theme.
 */
